...
const (
	fetchUserByEmailQuery       = "SELECT id, name, email, phone_number, password FROM user WHERE email = ?"
	fetchUserByPhoneNumberQuery = "SELECT id, name, email, phone_number, password FROM user WHERE phone_number = ?"
